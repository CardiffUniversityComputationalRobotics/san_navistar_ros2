...
class Config(object):
    ...
    env.randomize_attributes = (
        False  # randomize the preferred velocity and radius of humans or not
    )
    env.seed = 0  # random seed for environment
    env.task = "navigation"  # navigation
    env.nav_times = 3
    ...
    sim.static_human_num = 0  # total number of humans
    sim.area_radius = 0.5  # total number of humans
    ...
    training.num_processes = 50  # how many training CPU processes to use
